      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button className="px-6 py-2 text-moch-500 dark:text-moch-400 border-2 border-moch-500 dark:border-moch-400 rounded-lg font-nunito font-medium hover:bg-moch-50 dark:hover:bg-moch-900/20 transition-colors duration-200">
              Log in
            </button>
            <button className="px-6 py-2 bg-moch-500 dark:bg-moch-600 text-white rounded-lg font-nunito font-bold hover:bg-moch-600 dark:hover:bg-moch-500 transition-colors duration-200">
              Sign up
            </button>
          </div>
